...
cp userland/lib/libpfring.so.9.0.0 $RPM_BUILD_ROOT/usr/lib
cd $RPM_BUILD_ROOT/usr/lib && ln -sf libpfring.so.9.0.0 libpfring.so.8 && cd -
...
/usr/lib/libpfring.a
/usr/lib/libpfring.so.9.0.0
/usr/lib/libpfring.so.9
...
%changelog
* Tue Oct 14 2025 <dvanhoucke@redborder.com> - 9.0.0
- merge with version 9.0.0-stable
