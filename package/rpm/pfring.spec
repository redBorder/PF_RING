...
# Requires: pfring-dkms = 8.6.0, net-tools
...
GIT info: rb-v8.6.0-rhel9:8749659248441ac27a82ec2fc04eae3f7dba138e
...
cp $HOME/PF_RING/userland/lib/libpfring.so.8.6.0     $RPM_BUILD_ROOT/usr/lib
cd $RPM_BUILD_ROOT/usr/lib && ln -sf libpfring.so.8.6.0 libpfring.so.8 && cd -
...
cp $HOME/PF_RING/userland/libpcap/libpcap.so.1.10.1	$RPM_BUILD_ROOT/usr/local/lib
#
# NOTE
