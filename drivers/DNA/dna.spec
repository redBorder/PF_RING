...
%post
if [ ! -f /etc/modprobe.d/pfring-dna.conf ]; then
   echo 'blacklist e1000e-dna' >> /etc/modprobe.d/pfring-dna.conf
   echo 'blacklist igb-dna' >> /etc/modprobe.d/pfring-dna.conf
   echo 'blacklist ixgbe-dna' >> /etc/modprobe.d/pfring-dna.conf
fi
